...
test_that("Mode at bound, min == mode", {
  ...
  expect_equal(d, d_test)
  d <- dtri(c(0.1, 0.6, 0.9), min = c(0, 1, 2), max = 3, mode = 2)
...
test_that("NaN produced, mode < min", {
  ...
  expect_equal(d, NaN)
  d <- expect_warning(dtri(c(1, 2, 3), min = c(1, 2, 3), max = 4, mode = 2))
...
test_that("NaN produced, min == mode == max", {
  ...
  expect_equal(d, NaN)
  d <- expect_warning(dtri(c(0, 1, 2), min = c(0, 1, 2), max = 2, mode = 2))
...
#   mg <- mgtri(c(1, 2, 3), min = 0, max = 1, mode = 0.5)
#   mg_test <- mgtri_test(c(1, 2, 3), 0, 1, 0.5)
#   expect_equal(mg, mg_test)
# })

# test_that("vector t, scalar params, non-symmetric", {
#   mg <- mgtri(c(1, 2, 3), min = 0, max = 1, mode = 0.8)
#   mg_test <- mgtri_test(c(1, 2, 3), 0, 1, 0.8)
#   expect_equal(mg, mg_test)
# })

# test_that("vector t, vector params, symmetric", {
#   mg <- mgtri(c(1, 2, 3), min = c(0, 1, 2), max = c(2, 3, 4), mode = c(1, 2, 3))
#   mg_test <- mgtri_test(c(1, 2, 3), c(0, 1, 2), c(2, 3, 4), c(1, 2, 3))
#   expect_equal(mg, mg_test)
# })
...
#   mg <- mgtri(c(1, 2, 3), min = c(0, 0, 0), max = 2, mode = 1)
#   mg_test <- mgtri_test(c(1, 2, 3), c(0, 0, 0), 2, 1)
#   expect_equal(mg, mg_test)
# })

# test_that("vector t, vector params recycled, non-symmetric", {
#   mg <- mgtri(c(1, 2, 3), min = c(0, 0.5, 1), max = 3, mode = 2)
#   mg_test <- mgtri_test(c(1, 2, 3), c(0, 0.5, 1), 3, 2)
#   expect_equal(mg, mg_test)
# })

# test_that("NaN produced, t == 0", {
#   mg <- expect_warning(mgtri(c(0, 1, 2), min = 0.4, max = 1.4, mode = 0.9))
#   mg_test <- mgtri_test(c(0, 1, 2), 0.4, 1.4, 0.9)
#   expect_equal(mg, mg_test)
#   mg <- expect_warning(mgtri(c(0, 1, 2), min = c(0.4, 0.5, 0.6), max = 1.4, mode = 0.9))
...
# test_that("NaN produced, mode < min", {
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = 0, max = 2, mode = -1))
#   expect_equal(mg, rep.int(NaN, 3))
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = c(0, 0.5, 1), max = 2, mode = -1))
#   expect_equal(mg, rep.int(NaN, 3))
# })

# test_that("NaN produced, min == mode == max", {
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = 2, max = 2, mode = 2))
#   expect_equal(mg, rep.int(NaN, 3))
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = c(0, 0.5, 1), max = 2, mode = 2))
#   expect_equal(mg, rep.int(NaN, 3))
# })
...
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = 0, max = -1, mode = 1))
#   expect_equal(mg, rep.int(NaN, 3))
#   mg <- expect_warning(mgtri(c(1, 2, 3), min = c(0, 0.5, 1), max = -1, mode = 1))
#   expect_equal(mg, rep.int(NaN, 3))
# })
...
# test_that("vector t, scalar params, symmetric", {
#   c <- ctri(c(1, 2, 3), min = 0, max = 1, mode = 0.5)
#   c_test <- ctri_test(c(1, 2, 3), 0, 1, 0.5)
#   expect_equal(c, c_test)
# })

# test_that("vector t, scalar params, non-symmetric", {
#   c <- ctri(c(1, 2, 3), min = 0, max = 1, mode = 0.8)
#   c_test <- ctri_test(c(1, 2, 3), 0, 1, 0.8)
#   expect_equal(c, c_test)
# })

# test_that("vector t, vector params, symmetric", {
#   c <- ctri(c(1, 2, 3), min = c(0, 1, 2), max = c(2, 3, 4), mode = c(1, 2, 3))
#   c_test <- ctri_test(c(1, 2, 3), c(0, 1, 2), c(2, 3, 4), c(1, 2, 3))
#   expect_equal(c, c_test)
# })
...
# test_that("vector t, vector params recycled, symmetric", {
#   c <- ctri(c(1, 2, 3), min = c(0, 0, 0), max = 2, mode = 1)
#   c_test <- ctri_test(c(1, 2, 3), c(0, 0, 0), 2, 1)
#   expect_equal(c, c_test)
# })

# test_that("vector t, vector params recycled, non-symmetric", {
#   c <- ctri(c(1, 2, 3), min = c(0, 0.5, 1), max = 3, mode = 2)
#   c_test <- ctri_test(c(1, 2, 3), c(0, 0.5, 1), 3, 2)
#   expect_equal(c, c_test)
# })

# test_that("NaN produced, t == 0", {
#   c <- expect_warning(ctri(c(0, 1, 2), min = 0.4, max = 1.4, mode = 0.9))
#   c_test <- ctri_test(c(0, 1, 2), 0.4, 1.4, 0.9)
#   expect_equal(c, c_test)
#   c <- expect_warning(ctri(c(0, 1, 2), min = c(0.4, 0.5, 0.6), max = 1.4, mode = 0.9))
#   c_test <- ctri_test(c(0, 1, 2), c(0.4, 0.5, 0.6), 1.4, 0.9)
#   expect_equal(c, c_test)
# })
...
# test_that("NaN produced, mode < min", {
#   c <- expect_warning(ctri(c(1, 2, 3), min = 0, max = 2, mode = -1))
#   expect_equal(c, rep.int(NaN + 0i, 3))
#   c <- expect_warning(ctri(c(1, 2, 3), min = c(0, 0.5, 1), max = 2, mode = -1))
#   expect_equal(c, rep.int(NaN + 0i, 3))
# })

# test_that("NaN produced, min == mode == max", {
#   c <- expect_warning(ctri(c(1, 2, 3), min = 2, max = 2, mode = 2))
#   expect_equal(c, rep.int(NaN + 0i, 3))
#   c <- expect_warning(ctri(c(1, 2, 3), min = c(0, 0.5, 1), max = 2, mode = 2))
#   expect_equal(c, rep.int(NaN + 0i, 3))
# })
...
#   c <- expect_warning(ctri(c(1, 2, 3), min = 0, max = -1, mode = 1))
#   expect_equal(c, rep.int(NaN + 0i, 3))
#   c <- expect_warning(ctri(c(1, 2, 3), min = c(0, 0.5, 1), max = -1, mode = 1))
#   expect_equal(c, rep.int(NaN + 0i, 3))
# })
...
#   es <- estri(c(0.1, 0.6, 0.9), min = c(0, 1, 2), max = c(2, 3, 4), mode = c(1, 2, 3))
#   es_test <- estri_test(c(0.1, 0.6, 0.9), c(0, 1, 2), c(2, 3, 4), c(1, 2, 3))
#   expect_equal2(es, es_test)
# })
